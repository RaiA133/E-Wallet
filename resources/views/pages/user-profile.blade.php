            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="/img/default-profile.jpg" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
                    ...
                    <form role="form" method="POST" action={{ route('profile.update') }} enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Tgl Lahir</label>
                                        <input class="form-control" type="date" name="tgl_lahir" value="{{ old('tgl_lahir', auth()->user()->tgl_lahir) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">No Identitas</label>
                                        <input class="form-control" type="text" name="no_identity" value="{{ old('no_identity', auth()->user()->no_identity) }}">
                                    </div>
                                </div>
                            </div>
